...
var UserInfoArgs_Req_DEFAULT *api.UserRequest

func (p *UserInfoArgs) GetReq() *api.UserRequest {
	if !p.IsSetReq() {
...
type UserInfoResult struct {
	Success *api.UserResponse
}

var UserInfoResult_Success_DEFAULT *api.UserResponse

func (p *UserInfoResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(api.UserResponse)
	}
...
func (p *UserInfoResult) GetSuccess() *api.UserResponse {
	if !p.IsSetSuccess() {
...
func (p *kClient) UserInfo(ctx context.Context, Req *api.UserRequest) (r *api.UserResponse, err error) {
